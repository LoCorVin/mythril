...
class WorldState:
    ...
    def create_account(self, balance=0, address=None, concrete_storage=False, dynamic_loader=None, contract_name=None):
        """
        ...
        new_account = Account(address, balance=balance, dynamic_loader=dynamic_loader, concrete_storage=concrete_storage, contract_name=contract_name)

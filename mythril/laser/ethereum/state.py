...
class WorldState:
    ...
    def create_account(self, balance=0, address=None, concrete_storage=False, contract_name=None):
        """
        ...
        new_account = Account(address, balance=balance, concrete_storage=concrete_storage, contract_name=contract_name)
